...
publish_source = 'dailymail.co.uk'
country = 'United Kingdom'
language = 'English'
images_path = []

# archive page
rss_page = c.download_page('https://www.dailymail.co.uk/articles.rss')
...
for i in rss_page.split('<item>')[1:]:
    ...
    # source_content          
    source_content = c.scrap('heading-tag-switch">(.*?)<div\s*class="shareArticles">', page)
