...
publish_source = 'channelnewsasia.com'
country = 'Singapore'
language = 'English'
images_path = []

rss_pages = c.download_page('https://www.channelnewsasia.com/news/rss')

for _ in rss_pages.split('<div class="rss-table-col1">')[1:]:
    
    rss_url = c.scrap('<a href="(.*?)"', _)
